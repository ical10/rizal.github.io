...
Here, by imposing the Neumann condition, we see a different pattern of heat diffusion compared to that without (see earlier post titled "Numerical modelling").
